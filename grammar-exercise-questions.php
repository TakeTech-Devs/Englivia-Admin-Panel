            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Questions for Grammar Exercise mock test <small>Create New Question</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="row">
                                    <form id="questionForm" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <h4 class="col-md-offset-1"><strong>Create a Question</strong></h4>
                                        <input type="hidden" id="add_question" name="add_question" value="9"
                                            aria-required="true">
                                        ...
                                        <div id="manual_entry">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-sm-6 col-xs-12">
                                                    <?php
                                                    // Fetch categories where type = 9 directly from tbl_categories
                                                ...
                                                WHERE tbl_subcategories.type = 9 
                                                ORDER BY tbl_subcategories.id ASC";
                                                    $db->sql($sql);
                                                ...
                                                <div class="col-md-8 col-sm-6 col-xs-12">
                                                    <div id="status" class="btn-group">
                                                        <label class="btn btn-default" data-toggle-class="btn-primary"
                                                            ...
                                                            <input type="radio" name="question_type" value="9" checked="">
                                                            Options
                                                        </label>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h2>Questions of Grammar Exercise test <small>View / Update / Delete</small>
                                        </h2>
                                    </div>
                                    <div class='col-md-12'>
                                        <div class='col-md-3'>
                                            <select id="edit_narration_category_id"
                                                name="edit_narration_category_id" required class="form-control">
                                                <option value="">Select Category</option>
                                                <?php
                                                if (!empty($categories)) {
                                                    foreach ($categories as $category) { ?>
                                ...
                                <div class="table__container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="grammar_exercise_question_management_table"></tbody>
                                    </table>
                ...
                <div class="modal-content" style="border-radius: 10px;">
                    ...
                    <div class="modal-body">
                        <form id="update_form" method="POST" data-parsley-validate
                            ...
                            <input type='hidden' name="current_affairs_question_id" id="narration_question_id"
                                value='' />
                            ...
                            <div class="form-group d-none">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12">
                                    <?php
                                    $sql = "SELECT id, category_name, Tag 
                                                            FROM tbl_categories 
                                                            WHERE type = 9 
                                                            ORDER BY id ASC";
                                    $db->sql($sql);
