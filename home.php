        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div role="main">
                        <!-- top tiles -->
                        <h1 style="color:black;font-size:29px;text-align:center;">Welcome to Englivia Admin Panel</h1>
                        <hr>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><?= get_count('id', 'question', '') + get_count('id', 'tbl_questions'); ?></div>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><?= get_count('id', 'category', '') + get_count('id', 'tbl_categories'); ?></div>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><?= get_count('id', 'subcategory') + get_count('id', 'tbl_subcategories'); ?></div>
