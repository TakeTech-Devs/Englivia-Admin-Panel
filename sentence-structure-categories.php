...
<head>
    ...
    <title>Sentence Structure Category Management | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
                                        ...
                                        <div class="table__container">
                                            ...
                                            <div class="table__sub__header">
                                                <div class="table__length" id="table__length">
                                                    <label>
                                                        ...
                                                        <select name="table__length" class="table__length__selector"
                                                            id="sentence_structure_category__table__length">
                                                ...
                                                <div id="tables_filter" class="tables__filter">
                                                    <label>
                                                        Search:
                                                        <input type="search" id="sentence_structure_category__data__search"
                                                ...
                                                <div class="table__buttons" style="display:none">
                                                    <button class="add_new" id="openAddNewModalBtn"><a
                                                            href="{{ route('admin.sentence_structure_category.add.view') }}"><i
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="sentence_structure_category_management_table"></tbody>
                                            </table>
                                            <div class="table__clearfix">
                                                <div class="hint-text" id="sentence_structure_category__hint__text"></div>
                                                <ul class="pagination" id="sentence_structure_category__table__pagination"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
