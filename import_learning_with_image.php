                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Import Learning With Image</h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="register_form"  method="POST" action ="db_operations.php"data-parsley-validate class="form-horizontal form-label-left">
                                        <input type="hidden" id="tbl_learning_detail" name="tbl_learning_detail" required value='1'/>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tbl_learning_detail"> Select CSV file</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="file" name="tbl_learning_detail" id="tbl_learning_detail" required class="form-control col-md-7 col-xs-12" accept=".csv" />
                                            </div>
                                        </div>
