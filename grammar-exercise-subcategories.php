                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <!-- <form id="category_form" class="form-horizontal form-label-left">
                                            <input type="hidden" id="category_type" name="category_type" value="9">

                                            <div class="form-group row ">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <?php
                                                    $sql = "SELECT * FROM `tbl_categories` where `type` = 9 ORDER BY id DESC";
                                                    $db->sql($sql);
                                                    $categories = $db->getResult();
                                                    ?>
                                                    <label for="category_name">Parent Category</label>
                                                    <select id="narration_category_id"
                                                        name="narration_category_id" required
                                                        class="form-control">
                                        ...
                                        <form id="category_form" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            <input type="hidden" id="category_type" name="category_type" value="9">
                                            ...
                                            <div class="form-group row" id="category_dropdown_row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <?php
                                                    $sql = "SELECT * FROM `tbl_categories` WHERE `type` = 9 ORDER BY id ASC";
                                                    $db->sql($sql);
                                                    $categories = $db->getResult();
                                                    ?>
                                                    <label for="category_name">Parent Category</label>
                                                    <select id="narration_category_id" name="narration_category_id" required class="form-control">
                                                        <option value="">Select Parent Category</option>
                                        ...
                                        <div class="table__container">
                                            ...
                                            <div class="table__sub__header">
                                                <div class="table__length" id="table__length">
                                                    <label>
                                                        ...
                                                        <select name="table__length" class="table__length__selector"
                                                            id="narration_category__table__length">
                                                ...
                                                <div id="tables_filter" class="tables__filter">
                                                    <label>
                                                        Search:
                                                        <input type="search" id="narration_category__data__search"
                                                ...
                                                <div class="table__buttons" style="display:none">
                                                    <button class="add_new" id="openAddNewModalBtn"><a
                                                            href="{{ route('admin.current_affairs_category.add.view') }}"><i
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="grammar_exercise_subcategory_management_table"></tbody>
                                            </table>
                                            <div class="table__clearfix">
                                                <div class="hint-text" id="narration_category__hint__text"></div>
                                                <ul class="pagination" id="narration_category__table__pagination">
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form id="update_form" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group row ">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    $categories = $db->getResult();
                                    ?>
                                    <label for="update_narration_category_id">Parent Category</label>
                                    <select id="update_narration_category_id"
                                        name="update_narration_category_id" required class="form-control">
