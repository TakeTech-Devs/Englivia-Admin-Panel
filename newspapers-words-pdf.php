...
<head>
    ...
    <title>Newspaper Words PDF Management | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Newspaper Words PDF Management <small>Add PDF</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <div id="toolbar" style="display: none">
                                    <div class="col-md-3">
                                        <button class="btn btn-danger btn-sm" id="delete_multiple_pdfs"
                                            title="Delete Selected PDFs"><em class='fa fa-trash'></em></button>
                                    </div>
                                    <div>
                                ...
                                <div class="table__container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="newspaper_words_pdf_management_table"></tbody>
                                    </table>
            ...
            <div class="modal-dialog" role="document" style="width: 850px;">
                <div class="modal-content" style="border-radius: 10px;">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="editModalLabel">Edit Newspaper Words PDF Details</h4>
                    </div>
                    <div class="modal-body">
                        <form id="update_form" method="POST" data-parsley-validate
                            class="form-horizontal form-label-left">
                            <input type='hidden' name="edit_id" id="edit_id" value='' />
                            <input type='hidden' name="update_pdf" id="update_pdf" value='4' />
