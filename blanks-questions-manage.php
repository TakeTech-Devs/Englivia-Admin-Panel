            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Questions for Fill in the blanks mock test <small>Create New Question</small></h2>
                            ...
                            <div class="x_content">
                                <div class="row">
                                    <form id="questionForm" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" id="add_question" name="add_question" value="8"
                                            aria-required="true">
                                        ...
                                        <div id="manual_entry">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-sm-6 col-xs-12">
                                                    <?php
                                                    // Fetch categories where type = 6 directly from tbl_categories
                                                ...
                                                <div class="col-md-8 col-sm-6 col-xs-12">
                                                    <div id="status" class="btn-group">
                                                        <label class="btn btn-default" data-toggle-class="btn-primary"
                                                            ...
                                                            <input type="radio" name="question_type" value="6" checked="">
                                                            Options
                                                        </label>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h2>Questions of fill in the blanks test <small>View / Update / Delete</small>
                                        </h2>
                                    </div>
                                    <div class='col-md-12'>
                                        <div class='col-md-3'>
                                ...
                                <div class="table__container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="blanks_question_management_table"></tbody>
                                    </table>
