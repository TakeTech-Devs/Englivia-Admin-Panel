...
<head>
    ...
    <title>Newspaper Words Category Management | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <form id="category_form" class="form-horizontal form-label-left">
                                            <input type="hidden" id="category_type" name="category_type" value="5">
                                            <input type="hidden" id="category_tag" name="category_tag" value="newspaper_words">
                                        ...
                                        <div class="table__container">
                                            <div class="table__header">
                                                <div class="table__title">
                                                    <h2>Newspaper Words Category</h2>
                                                </div>
                                            ...
                                            <div class="table__sub__header">
                                                <div class="table__length" id="table__length">
                                                    <label>
                                                        ...
                                                        <select name="table__length" class="table__length__selector"
                                                            id="newspaper_words_category__table__length">
                                                ...
                                                <div id="tables_filter" class="tables__filter">
                                                    <label>
                                                        Search:
                                                        <input type="search"
                                                            id="newspaper_words_category__data__search"
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="newspaper_words_category_management_table"></tbody>
                                            </table>
                                            <div class="table__clearfix">
                                                <div class="hint-text" id="newspaper_words_category__hint__text">
                                                </div>
                                                <ul class="pagination"
                                                    id="newspaper_words_category__table__pagination"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog" role="document" style="width: 850px;">
                <div class="modal-content" style="border-radius: 10px;">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="editCategoryModalLabel">Edit Category Details</h4>
                    </div>
                    <div class="modal-body">
                        <form id="update_form" class="form-horizontal form-label-left">
                            <input type="hidden" id="edit_id" name="edit_id">
                            <input type="hidden" id="edit_category_type" name="edit_category_type" value="5">
                            <input type="hidden" id="edit_category_tag" name="edit_category_tag" value="newspaper_words">
