                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class='row'>
                                    <form id="category_form_voice" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <input type="hidden" id="category_type" name="category_type" value="7">
                                        <input type="hidden" id="category_tag" name="category_tag" value="VC">
                                    ...
                                    <div class='col-md-12'>
                                        ...
                                        <div class="table__container">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="voice_category_management_table"></tbody>
                                            </table>
