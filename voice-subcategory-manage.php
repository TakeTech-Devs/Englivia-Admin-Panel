                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <form id="category_form" class="form-horizontal form-label-left">
                                            <input type="hidden" id="category_type" name="category_type" value="7">

                                            <div class="form-group row ">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <?php
                                                    $sql = "SELECT * FROM `tbl_categories` where `type` = 7 ORDER BY id DESC";
                                                    $db->sql($sql);
                                    ...
                                    <div class='col-md-12'>
                                        ...
                                        <div class="table__container">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="voice_subcategory_management_table"></tbody>
                                            </table>
