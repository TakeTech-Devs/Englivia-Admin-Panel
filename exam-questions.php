                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                            <h4 class="col-md-offset-1"><strong>Create MCQ Question</strong></h4>
                                            <input type="hidden" id="add_learning_question" name="add_exam_question" required value="1">
                                            <input type="hidden" id="learning_id" name="learning_id" value="<?= $_GET['id'] ?>" required>

                                            <div class="form-group">
                                                <label class="control-label col-md-1 col-sm-3 col-xs-12" for="question">MCQ Question</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-1 col-sm-3 col-xs-12" for="a">Answer Options</label>
                                                <div class="col-md-8 col-sm-6 col-xs-12"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="a" class="control-label col-md-1 col-sm-3 col-xs-12">Options A</label>
                                                <div class="col-md-4 col-sm-6 col-xs-12">
                                                    <input id="a" class="form-control" type="text" value="" name="a">
                                                </div>
                                                <label for="b" class="control-label col-md-1 col-sm-3 col-xs-12">Options B</label>
                                            ...
                                            <div id="tf">
                                                <div class="form-group" >
                                                    <label for="c" class="control-label col-md-1 col-sm-3 col-xs-12">Options C</label>
                                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                                        <input id="c" class="form-control" type="text" name="c">
                                                    </div>
                                                    <label for="d" class="control-label col-md-1 col-sm-3 col-xs-12">Options D</label>
                                                    <div class="col-md-5 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-1 col-sm-3 col-xs-12" for="answer">Select Right Answer</label>
                                                <div class="col-md-10 col-sm-6 col-xs-12">
                                          ...
                                          <div class="form-group">
                                                <label class="control-label col-md-1 col-sm-3 col-xs-12" for="note">Answer Note</label>
                                                <div class="col-md-10 col-sm-6 col-xs-12">
                                    ...
                                    <table aria-describedby="mydesc" class='table-striped' id='questions'
                                           data-toggle="table" data-url="get-list.php?table=exam_question"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th scope="col" data-field="answer" data-sortable="true" data-visible='true'>Answer</th>
                        ...
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                <input type='hidden' name="question_id" id="question_id" value=''/>
                                 <input type="hidden" id="edit_question_type"  name="edit_question_type" value="">
                              ...
                              <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <textarea type="text" id="edit_note" name="note" required="required" class="form-control col-md-7 col-xs-12" aria-required="true"></textarea>
                                    </div>
                                </div>
