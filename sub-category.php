                                            ...
                                            <table  aria-describedby="mydesc" class='table-striped' id='category_list'
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" data-field="category_name" data-sortable="true">Subjects</th>
                                                        <th scope="col" data-field="subcategory_name" data-sortable="true">Sections</th>
                        ...
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="update_name" placeholder="Sections Name" class='form-control' required>
                                </div>
                                <div style="display: none">
