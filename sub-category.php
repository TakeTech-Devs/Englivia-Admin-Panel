...
<head>
    ...
    <title>Create and Manage Sections | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <form id="category_form" method="POST" action="db_operations.php"
                                            class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            <input type="hidden" id="add_subcategory" name="add_subcategory" required=""
                                            ...
                                            if ($fn->is_language_mode_enabled()) {
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <label for="maincat_id">Subject</label>
                                                        <select id="maincat_id" name="maincat_id" required
                                                            class="form-control">
                                    ...
                                    <div class='col-md-12'>
                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='category_list'
                                            ...
                                            data-maintain-selected="true" data-show-export="false"
                                            data-export-types='["txt","excel"]' data-export-options='{
                                                    "fileName": "subcategory-list-<?php echo date('d-m-y') ?>",
                                                    "ignoreColumn": ["state"]	
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" data-field="row_order" data-visible='false'
                                                    ...
                                                    <?php if ($fn->is_language_mode_enabled()) { ?>
                                                        ...
                                                        <th scope="col" data-field="language" data-sortable="true"
                                                            data-sort-name="l.language">Language</th>
                                                    <?php } ?>
                                                    <th scope="col" data-field="maincat_id" data-sortable="true"
                                                        data-visible='false'>Subjects ID</th>
                                                    ...
                                                    <th scope="col" data-field="no_of_que" data-sortable="false">Total
                                                        Question</th>
                                        ...
                                        <!-- <table aria-describedby="mydesc" class='table-striped' id='category_list'
                                            ...
                                            data-export-types='["txt","excel"]' data-export-options='{
                                            "fileName": "users-list-<?= date('d-m-y') ?>","ignoreColumn": ["state"]}'
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th scope="col" data-field="maincat_id" data-sortable="true" data-visible='false'>Subjects ID</th>
                                                    <th scope="col" data-field="category_name" data-sortable="true">
                                                        Subjects</th>
                                                    <th scope="col" data-field="subcategory_name" data-sortable="true">
                                                        Sections</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="update_form" method="POST" action="db_operations.php" data-parsley-validate
                            ...
                            <?php } ?>
                            <label class="" for="update_maincat_id">Subjects</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="update_name" placeholder="Sections Name"
        ...
        <?php if ($fn->is_language_mode_enabled()) { ?>
            $('#language_id').on('change', function (e) {
                ...
                $.ajax({
                    ...
                    data: 'get_categories_of_language=1&language_id=' + language_id + '&type=1',
                    beforeSend: function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == 1) {
                            ...
                            alert('Error! Subjects could not be deleted');
                    }
                });
            }
        });
    ...
    <script>
        $('#category_form').on('submit', function (e) {
            ...
            if ($("#category_form").validate().form()) {
                if (confirm('Are you sure? Want to create Sections')) {
                    $.ajax({
                        type: 'POST',
