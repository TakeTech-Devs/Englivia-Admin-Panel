                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="subcategory">Sections</label>
                                                <div class="col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-1 col-sm-3 col-xs-12" for="level">Level (Number Only)</label>
                                                <div class="col-md-10 col-sm-6 col-xs-12">
                                    ...
                                    <table aria-describedby="mydesc" class='table-striped' id='questions'
                                           ...
                                           data-pagination="true" data-page-list="[50, 100, 200]"  
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-field="category" data-sortable="true" data-visible='false'>Subjects</th>
                                                <th scope="col" data-field="subcategory" data-sortable="true" data-visible='false'>Sections</th>
                                                <?php if ($fn->is_language_mode_enabled()) { ?>
                                                ...
                                                <?php } ?>
                                                <th scope="col" data-field="image" data-sortable="false" data-visible='false'>Image</th>
                                                ...
                                                <?php if ($fn->is_option_e_mode_enabled()) { ?>
                                                    <th scope="col" data-field="optione" data-sortable="true" data-visible='false'>Option E</th>
                                                <?php } ?>
                                                <th scope="col" data-field="answer" data-sortable="true" >Answer</th>
                                                <th scope="col" data-field="level" data-sortable="true">Level</th>
                                                <th scope="col" data-field="note" data-sortable="true" data-visible='true'>Note</th>
                        ...
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                if ($fn->is_language_mode_enabled()) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10 col-sm-6 col-xs-12">
                                            ...
                                            $languages = $db->getResult();
                                            ?>
                                            <select id="update_language_id" name="update_language_id" required class="form-control col-md-7 col-xs-12">
                                                <option value="">Select language</option>
                                                <?php foreach ($languages as $language) { ?>
                                                    <option value='<?= $language['id'] ?>'><?= $language['language'] ?></option>
                                                <?php } ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-3 col-xs-12" for="question">Question</label>
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <textarea type="text" id="edit_question" name="edit_question" required="required" class="form-control col-md-7 col-xs-12" aria-required="true"></textarea>
                                    </div>
                                </div>
                            ...
                            <div style="display:none">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">                                                     
                                        <div id="status" class="btn-group">
                                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" id="edit_question_type" name="edit_question_type" value="1" checked=""> Options 
                                            </label>
                                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" id="edit_question_type" name="edit_question_type" value="2"> True / False
                                            </label>                                                        
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="a" class="control-label col-md-1 col-sm-3 col-xs-12">A</label>
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <input id="edit_a" class="form-control col-md-7 col-xs-12" type="text" name="edit_a">
                                    </div>
                                    <label for="b" class="control-label col-md-1 col-sm-3 col-xs-12">B</label>
                                    <div class="col-md-5 col-sm-6 col-xs-12">
                                        <input id="edit_b" class="form-control col-md-7 col-xs-12" type="text" name="edit_b">
                                    </div>
                                </div>
                                <div id="edit_tf">
                                    <div class="form-group" >
                                        <label for="c" class="control-label col-md-1 col-sm-3 col-xs-12">C</label>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <input id="edit_c" class="form-control col-md-7 col-xs-12" type="text" name="edit_c">
                                        </div>
                                        <label for="d" class="control-label col-md-1 col-sm-3 col-xs-12">D</label>
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            <input id="edit_d" class="form-control col-md-7 col-xs-12" type="text" name="edit_d">
                                        </div>
                                    </div>
                                    <?php if ($fn->is_option_e_mode_enabled()) { ?>
                                        <div class="form-group">
                                            <label for="e" class="control-label col-md-1 col-sm-3 col-xs-12">E</label>
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <input id="edit_e" class="form-control col-md-7 col-xs-12" type="text" name="edit_e">
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <input type="text" id="edit_level" name="edit_level" required="required" class="form-control col-md-7 col-xs-12" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-3 col-xs-12" for="answer">Answer</label>
