                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <form id="category_form" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" id="category_tag" name="category_tag" value="GE">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" id="submit_btn" class="btn btn-warning">Submit</button>
                                            </div>
                                        </form>
                                        ...
                                        <div class="table__container">
                                            <div class="table__header">
                                                <div class="table__title">
                                                    <h2>Grammar Exercise Categories</h2>
                                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="grammar_exercise_category_management_table"></tbody>
                                            </table>
