            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Questions for Voice Change mock test <small>Create New Question</small></h2>
                            ...
                            <div class="x_content">
                                <div class="row">
                                    <form id="questionForm" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" id="add_question" name="add_question" value="7"
                                            aria-required="true">
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h2>Questions of Voice Change test <small>View / Update / Delete</small>
                                        </h2>
                                    </div>
                                    <div class='col-md-12'>
                                        <div class='col-md-3'>
                                ...
                                <div class="table__container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="voice_question_management_table"></tbody>
                                    </table>
