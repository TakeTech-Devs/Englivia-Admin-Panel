                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                        <input type="hidden" id="add_learning" name="add_dictionary" required value="1" aria-required="true">
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h2>Dictionary Zone <small>View / Update / Delete</small></h2>
                                    </div>
                                ...
                                <div id="toolbar">
                                   ...
                                   <div class='row'>
                                            ...
                                            <?php } ?>
                                            <div class='col-md-3'>
                                                <button class='btn btn-primary btn-block' id='filter_btn'>Filter Sections</button>
                                            </div>
                                           
                                        </div>
                                  
                                <table aria-describedby="mydesc" class='table-striped' id='learnings'
                                       data-toggle="table" data-url="get-list.php?table=dictionary_zone"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <input type='hidden' name="update_dictionary" id="update_dictionary" value='1'/>
                            <input type='hidden' name="edit_language_id" id="edit_language_id" value='1'/>
                            <?php
                            $db->sql("SET NAMES 'utf8'");
                            if ($fn->is_language_mode_enabled()) {
                                ?>
                            ...
                            <div class="form-group row">                                                    
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input id="edit_title" name="edit_title" type="text" class="form-control" placeholder="Enter Title" required>
                                </div>                                   
                            </div>
...
<?php } ?>
    ...
    <script>
        $(document).on('click', '.delete-data', function () {
            if (confirm('Are you sure? Want to delete dictionary? All related data will also be deleted')) {
                id = $(this).data("id");
                $.ajax({
                    url: 'db_operations.php',
                    type: "get",
                    data: 'id=' + id + '&delete_dictionary=1',
                    success: function (result) {
                        if (result == 1) {
